...
public partial class UniversityReports : Form
{
    private readonly AdminBLL _bll = new();

    public UniversityReports()
    {
        InitializeComponent();
    }
